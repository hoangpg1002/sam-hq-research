...
class CrossBranchAdapter(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Sequential(nn.Conv2d(in_channels=256,out_channels=256,kernel_size=3, padding=1, stride=1),
                                  nn.Sigmoid())
        ...
        self.downchannelmax=nn.Conv2d(in_channels=768,out_channels=128,kernel_size=1,stride=1)
        self.downchannelmean=nn.Conv2d(in_channels=768,out_channels=128,kernel_size=1,stride=1)
        self.act=nn.Sigmoid()
